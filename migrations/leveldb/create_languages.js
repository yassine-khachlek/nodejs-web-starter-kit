...
var db = levelup('./database/language')
...
db.createReadStream({keyEncoding: 'utf8',valueEncoding: 'json',sync: true})
  .on('data', function (data) {
    ...
    languagesISO2.push(data.value.iso['639']['1']);
  })
  ...
  .on('close', function () {
    ...
    languages.forEach(function(language, index){
      ...
      if( languagesISO2.indexOf(language.iso['639']['1'])<0 ){

        console.log('NOT FOUND: ', language.iso['639']['1']);

        db.put(language.id, language, {keyEncoding: 'utf8',valueEncoding: 'json',sync: true},function (err) {
        ...
        console.log('EXIST', language.iso['639']['1']);
      }
